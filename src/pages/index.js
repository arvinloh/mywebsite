...
import Preloader from "@site/src/components/Preloader/Preloader";
  ...
  return (
    <header className={clsx("hero hero--primary", styles.heroBanner)}>
      <div className="container">
        ...
        <img src="/img/Myproject.png" alt="Featured Project" width="300px" />
        <br /><br />
...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className={clsx(styles.contentWrapper, { [styles.show]: loaded })}>
        <Layout
          title="Homepage"
